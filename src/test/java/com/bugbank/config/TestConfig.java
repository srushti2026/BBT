...
public final class TestConfig {
  ...
  public static final String EMAIL = System.getProperty("test.email", "prtwo@gmail.com");
  public static final String PASSWORD = System.getProperty("test.password", "Pleasework@05");
  ...
  public static final long ACTION_PAUSE_MILLIS = Long.getLong("actionPauseMillis", 500L);
